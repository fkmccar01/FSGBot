...
def groupme_webhook():
    ...
    if any(bot_name in text_lower for bot_name in bot_aliases):
            ...
            # URLs for your leagues
            GOONDESLIGA_URL = "https://xperteleven.com/standings.aspx?Lid=460905"
            SPOONDESLIGA_URL = "https://xperteleven.com/standings.aspx?Lid=460906"
    
            # Scrape standings and fixtures separately
            goon_standings = scrape_league_standings_with_login(session, GOONDESLIGA_URL)
            spoon_standings = scrape_league_standings_with_login(session, SPOONDESLIGA_URL)
            ...
            # Build last match data for strength calculations
